...
# svc002
OUTPUT_IMAGE_SAVE_DIRECTORY = "/home1/irteamsu/users/rklee/TheIllusionsLibraries/GANs/wgan/generated_face_imgs_v1/"
# i7-2600k (Ubuntu)
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        disc_total_loss = -tf.reduce_mean(disc_real) + tf.reduce_mean(disc_fake)
        ...
        # weight clipping
        clip_D = [p.assign(tf.clip_by_value(p, -0.01, 0.01)) for p in discriminator.var_list_disc]
