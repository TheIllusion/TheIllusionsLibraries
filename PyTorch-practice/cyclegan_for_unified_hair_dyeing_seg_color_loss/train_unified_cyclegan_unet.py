...
print 'unified_cyclegan_for_hair_dyeing_unet'
...
MODEL_SAVING_DIRECTORY = '/home1/irteamsu/rklee/TheIllusionsLibraries/PyTorch-practice/cyclegan_for_unified_hair_dyeing/models_unet/'
RESULT_IMAGE_DIRECTORY = '/home1/irteamsu/rklee/TheIllusionsLibraries/PyTorch-practice/cyclegan_for_unified_hair_dyeing/result_images_unet/'
...
'''
if not os.path.exists(MODEL_SAVING_DIRECTORY + 'tf_board_logger_unet'):
    os.mkdir(MODEL_SAVING_DIRECTORY + 'tf_board_logger_unet')

logger = Logger(MODEL_SAVING_DIRECTORY + 'tf_board_logger_unet')
        ...
        if i % 500 == 0:
            ...
            for file_idx in range(1):
                ...
                cv2.imwrite(os.path.join(RESULT_IMAGE_DIRECTORY, \
                                         'unified_cyclegan_unet_generated_iter_' + str(i) + '_' + str(file_idx) + '.jpg'),
                            output_img_opencv)

        # save the model
        if i % MODEL_SAVING_FREQUENCY == 0:
            torch.save(gen_model_a.state_dict(),
                       MODEL_SAVING_DIRECTORY + 'unified_cyclegan_unet_model_iter_' + str(i) + '.pt')
