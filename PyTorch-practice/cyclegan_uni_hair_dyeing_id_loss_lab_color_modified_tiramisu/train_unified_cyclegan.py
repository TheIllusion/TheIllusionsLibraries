...
print 'cyclegan_uni_hair_dyeing_id_loss_lab_color_modified_tiramisu'
...
TF_BOARD_DIRECTORY = '/home1/irteamsu/rklee/TheIllusionsLibraries/PyTorch-practice/cyclegan_uni_hair_dyeing_id_loss_lab_color_modified_tiramisu/tfboard/'
    ...
    for i in range(TOTAL_ITERATION):
        ...
        if i % MODEL_SAVING_FREQUENCY == 0:
            torch.save(gen_model_a.state_dict(),
                       MODEL_SAVING_DIRECTORY + 'cyclegan_uni_hair_modified_tiramisu_iter_' + str(i) + '.pt')
