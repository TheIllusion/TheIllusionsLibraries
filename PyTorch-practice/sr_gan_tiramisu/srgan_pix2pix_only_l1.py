...
print 'srgan_pix2pix_only_l1.py'
...
# T005
MODEL_SAVING_DIRECTORY = '/home1/irteamsu/rklee/TheIllusionsLibraries/PyTorch-practice/sr_gan_tiramisu/generator_checkpoints_only_l1/'

TF_BOARD_DIRECTORY = '/home1/irteamsu/rklee/TheIllusionsLibraries/PyTorch-practice/sr_gan_tiramisu/tfboard_only_l1/'
...
if __name__ == "__main__":
    ...
    for i in range(TOTAL_ITERATION):
        ...
        # disable the gan loss and use only l1-loss
        #loss_gen_total_lsgan = 5 * loss_gen_lsgan + 0.01 * l1_loss
        loss_gen_total_lsgan = 0.01 * l1_loss
        ...
        if i % MODEL_SAVING_FREQUENCY == 0:
            torch.save(gen_model.state_dict(),
                       MODEL_SAVING_DIRECTORY + 'sr_gan_tiramisu_only_l1_iter_' + str(i) + '.pt')
