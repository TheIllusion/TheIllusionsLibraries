...
if __name__ == '__main__':
    ...
    for img_file in img_files:
        ...
        if type(img) is np.ndarray:
            ...
            edge_preserving_result = cv2.ximgproc.edgePreservingFilter(img, d=40, threshold=15)
            ...
            concated_img = np.hstack((img, edge_preserving_result, bilateral_result, l0_result, bi_and_l0_result))
